use crate::{fdb_key_value, fdb_relationship, fdb_table};

fdb_table! {
    group (uuid) {
        uuid -> String,
        organizations_uuid -> String,
        name -> String,
        access_all -> bool,
        external_id -> Option<String>,
        creation_date -> chrono::Utc,
        revision_date -> chrono::Utc
    }
}
...
// fdb_key_value! { invitations(email) }
//
// fdb_table! {
